...
cur.execute("INSERT INTO referencia (url_wikipedia, nombre_referencia, profesion, fecha_nacimiento, nacionalidad) VALUES ('https://en.wikipedia.org/wiki/Placeholder_name', 'John Doe', 'Comerciante', '2000-01-01', 'Chilena')")
cur.execute("INSERT INTO popularidad (id_popularidad, fecha, valor, nombre_referencia) VALUES (250, '2022-01-01', 2597, 'John Doe')")
cur.execute("INSERT INTO propietario (id_prensa, nombre_dueño, fecha_dueño) VALUES (8, 'Agustín Edwards', '2016-01-01')")
cur.execute("INSERT INTO mencionar (url_noticia, nombre_referencia) VALUES ('https://www.estrellavalpo.cl/impresa/2019/10/25/full/cuerpo-principal/1/', 'John Doe')")
conn.commit()
conn.close()